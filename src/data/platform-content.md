# SafulPay Platform — Content Reference

> Structured content for the `/platform` page and the `SolutionsPreview` section on the homepage.
> Use this file as the single source of truth when updating copy.

---

## Homepage — Solutions Preview Section
...
## Platform Page — Agency Section

**Badge:** Agency Platform

**Headline:** Run an agent business that scales.

**Sub-heading:** Your shop. A financial business.

**Body:** Turn your existing shop into a SafulPay agent point. Offer the services customers come asking for, and earn commission on every one.

**CTA Primary:** Become an agent
**CTA Secondary:** See agent tools
...
## Platform Page — Merchant Section
...
Restaurants · Retail shops · Hotels · Offices · Schools · NGOs · Pharmacies · Salons · Service providers

**Tag:** Receive QR, link and in-app payments. Pay salaries and suppliers in bulk. Built for restaurants, retailers, offices and NGOs.

---

## Platform Page — Developer Section
...
**Body:** REST and websocket APIs for every wallet, bank, biller and remittance flow in Sierra Leone. Embed payments into your product in an afternoon.
...
## Platform Page — User Section (Hero tab)
...
## Homepage — Features Section (Everything in one place)
...
**Heading:** Your money. Your way. Today.

**Body:** Download SafulPay and join hundreds of thousands of people moving money smarter across Sierra Leone.

**CTA Primary:** Download for iOS
**CTA Secondary:** Download for Android
